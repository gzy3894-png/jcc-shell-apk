...
#define JCC_TRC_MODEL 0x88                 
#define JCC_TRM_CUR_RECOMMEND 0x40         
#define JCC_TRM_CUR_STAGE_DATA 0x50        
#define JCC_SRTD_HERO_EQUIPS 0x10          
#define JCC_SRTD_CORE_HERO 0x50           

#define JCC_CBG_SCREEN_MGR 0x108          
#define JCC_BSM_SCREEN 0x10               
